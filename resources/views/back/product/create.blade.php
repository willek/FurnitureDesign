...
<div class="block">
  ...
  <form id="form-data" action="{{ route('back.created_product') }}" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
    {!! csrf_field() !!}
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
        <div class="input-group">
          ...
          <input type="text" id="example-price" name="price" class="form-control numeric-only" required>
        </div>
      </div>
    </div>
    <div class="form-group">
