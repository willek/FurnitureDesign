...
<div class="block">
  ...
  <form id="form-data" action="{{ route('back.updated_testimonials', $testimonials->id) }}" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered">
    {!! csrf_field() !!}
    <div class="form-group">
      <label class="col-md-2 control-label" for="example-name">Name</label>
      <div class="col-md-8">
        <input type="text" id="example-name" name="name" class="form-control" placeholder="Name" required value="{{ $testimonials->name }}">
      </div>
    </div>
    <div class="form-group">
      <label class="col-md-2 control-label" for="example-occupation">Occupation</label>
      <div class="col-md-8">
        <input type="text" id="example-occupation" name="occupation" class="form-control" placeholder="Occupation" required value="{{ $testimonials->occupation }}">
      </div>
    </div>
    <div class="form-group">
      <label class="col-md-2 control-label" for="example-file">Image</label>
      <div class="col-md-8">
        <a href="{{ $testimonials->imagedir }}" data-toggle="lightbox-image">
          <img src="{{ $testimonials->imagedir }}" class="img-responsive img-circle img-testi">
        </a>
    ...
    <div class="form-group">
      ...
      <div class="col-md-8">
        <textarea id="example-textarea-content" name="content" rows="7" class="form-control" style="resize: none;">{{ $testimonials->content }}</textarea>
      </div>
    </div>
